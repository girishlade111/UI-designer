...
export const PROVIDERS: Provider[] = [
  {
    ...
    models: [
      { id: 'google/gemini-2.0-flash-001:free', name: 'Gemini 2.0 Flash', type: 'free' },
      ...
      { id: 'anthropic/claude-3-haiku:free', name: 'Claude 3 Haiku', type: 'free' },
      { id: 'openai/gpt-4o', name: 'GPT-4o', type: 'paid' },
      { id: 'openai/gpt-4o-mini:free', name: 'GPT-4o Mini', type: 'free' },
      { id: 'meta-llama/llama-3.1-70b-instruct:free', name: 'Llama 3.1 70B', type: 'free' },
      { id: 'meta-llama/llama-3.1-8b-instruct:free', name: 'Llama 3.1 8B', type: 'free' },
      { id: 'mistralai/mistral-7b-instruct:free', name: 'Mistral 7B', type: 'free' },
      { id: 'qwen/qwen-2-72b-instruct:free', name: 'Qwen 2 72B', type: 'free' },
      { id: 'deepseek/deepseek-chat:free', name: 'DeepSeek Chat', type: 'free' },
      { id: 'google/gemma-2-27b-instruct:free', name: 'Gemma 2 27B', type: 'free' },
    ],
  },
  {
    id: 'groq',
